  ...
  <div>
    ...
    <div class="flex flex-wrap justify-between shadow bg-gray-200" v-else>
          ...
          <div class="lg:w-4/5 right-0 xs:9/12">
            <div class="pl-4 font-hairline">
              ...
              <div class="flex">
                ...
                <span
                  class="inline-block rounded-full bg-gray-300 h-2 w-2 m-2"
                ></span>
              </div>
              <div class="relative">
      ...
      <div class="lg:w-1/4 mt-10 lg:pr-20 w-full px-3 mb-8">
        ...
        <div
          class="shadow bg-white p-4 rounded leading-loose text-sm text-gray-700"
        >
        ...
        <p
          class="text-black mt-4 font-normal text-sm font-semibold tracking-widest"
        >
          PAYMENT SUMMERY
        </p>
        <div
          class="text-sm right-0 pb-3 leading-loose shadow bg-white mt-2 rounded p-4"
        >
