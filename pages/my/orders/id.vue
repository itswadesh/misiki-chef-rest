<template>
  <div>
    ...
    <div class="flex flex-wrap justify-between shadow bg-gray-200" v-else>
      ...
      <div class="xs:w-full lg:w-2/4 mt-5 p-2">
        ...
        >
          <div>
            <img class="lg:rounded xs:rounded-b-none w-32" v-lazy="i.img" alt />
          </div>
            ...
            <div class="pl-4 font-hairline">
              ...
              <div v-if="order.status == 'Cancelled'">
                <div class="rnd-mnt flex">
                  <div class="h-4">
                    <img src="/return.svg" class="rounded-full p-2 w-6 bg-blue-500 mr-2" alt />
                  </div>
                  <div class="text-sm" style="margin-top:2px;">Cancelled on {{ order.date | date }}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="lg:w-1/4 mt-10 lg:pr-20 w-full px-3 mb-8">
        ...
        <div class="text-sm right-0 pb-3 leading-loose shadow bg-white mt-2 rounded p-4">
          <div class="border-b border-gray-300 text-gray-700">
            ...
            <div class="flex justify-between mt-1" v-if="order.amount.discount > 0">
        ...
        >
          ...
          <br />
          <div>
            <nuxt-link to="/help" class="text-pink-500">Visit our help center</nuxt-link>
          </div>
        </div>
      </div>
      <div class="w-8"></div>
